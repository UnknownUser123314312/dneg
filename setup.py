...
setup(
    name='dneg',  # Replace with your desired package name
    ...
    author='UnknownUser123314312',  # Replace with your name
    author_email='8i40irjqx@mozmail.com',  # Replace with your email
    url='https://github.com/UnknownUser123314312/dneg',  # Replace with your repo URL (if available)
