...
class PipelineTests:
    ...
    def pipeline_english_test():
        ...
        mcue_path = "D-NEG/cue-en-conan"
        mscope_path = "D-NEG/scope-en-bioscope_abstracts"
        ...
        mcue_path = "D-NEG/cue-gat-en-socc"
        mscope_path = "D-NEG/scope-gat-en-bioscope_abstracts"
    ...
    def pipeline_german_test():
        mcue_path = "D-NEG/cue-de-conan"
        mscope_path = "D-NEG/scope-de-bioscope_abstracts"
        pipe = Pipeline(components=[CueBertInference, ScopeBertInference],
                        model_paths=[mcue_path, mscope_path],
                        device="cuda:0",
                        max_length=128)
        ...
        mcue_path = "D-NEG/cue-gat-de-conan"
        mscope_path = "D-NEG/scope-gat-de-bioscope_abstracts"
        pipe = Pipeline(components=[CueBertInferenceGAT, ScopeBertInferenceGAT],
                        model_paths=[mcue_path, mscope_path],
                        device="cuda:0",
                        max_length=128,
